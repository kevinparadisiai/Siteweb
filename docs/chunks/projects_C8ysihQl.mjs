const projects = [
  {
    ...
    lede: "Una pagina post-chiamata che intercetta la richiesta appena chiusa e riduce la probabilità di un secondo contatto. Dati customer care + survey → contenuti mirati sulle casistiche ricorrenti.",
    intro: [
  ...
  },
  {
    ...
    lede: "Da spazio informativo a piattaforma capace di supportare processi complessi e profili molto diversi tra loro — clienti privati, amministratori di condominio, business, enti pubblici.",
    intro: [
  ...
  },
  {
    ...
    lede: "Un portale che rende consultabile online un archivio fisico di rilevanza storica: integrità, contestualizzazione, esperienza chiara per un'utenza tecnica.",
    intro: [
