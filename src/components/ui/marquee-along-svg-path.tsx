...
interface CSSVariableInterpolation { property: string; from: number | string; to: number | string; }
          ...
          return (
            <motion.div
              ...
              style={{
                ...
                offsetDistance: itemOffset as unknown as string,
                zIndex: enableRollingZIndex ? (zIndex as unknown as number) : undefined,
